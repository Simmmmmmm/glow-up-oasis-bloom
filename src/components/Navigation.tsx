...
import { Heart, Book, Calendar, CheckCircle, Sparkles, User, Moon, Sun, Menu } from 'lucide-react';
  ...
  return (
    <nav className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-sm border-b border-pink-100 dark:border-gray-700">
      <div className="container mx-auto px-2 sm:px-4">
        <div className="flex items-center justify-between h-14 sm:h-16">
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full flex items-center justify-center">
              <Heart className="w-3 h-3 sm:w-5 sm:h-5 text-white" fill="currentColor" />
            </div>
            <h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
              GlowUp
            </h1>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-pink-100 dark:border-gray-700 py-2">
